...
public class SuccessExpr {
	...
	@ReturnSecurity("high")
	public int expr() {
		int op1High = Definition.highId(42);
		int op2High = Definition.highId(42);
	...
	public boolean expr10() {
		boolean op1High = Definition.highId(false);
		boolean op2High = Definition.highId(false);
		return op1High && op2High;
	}
	...
	public int expr15() {
		int op1High = Definition.highId(42);
		int op2Low = Definition.lowId(42);
	...
	public boolean expr24() {
		boolean op1High = Definition.highId(false);
		boolean op2Low = Definition.lowId(false);
		return op1High && op2Low;
	}
	...
	@ReturnSecurity("high")
	public int expr29() {
		int op1Low = Definition.lowId(42);
		int op2High = Definition.highId(42);
	...
	public boolean expr38() {
		boolean op1Low = Definition.lowId(false);
		boolean op2High = Definition.highId(false);
		return op1Low && op2High;
	}
