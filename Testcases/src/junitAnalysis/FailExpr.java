...
public class FailExpr {
	...
	@ReturnSecurity("low")
	public int expr() {
		int op1High = Definition.mkHigh(42);
		int op2High = Definition.mkHigh(42);
	...
	public boolean expr10() {
		boolean op1High = Definition.mkHigh(false);
		boolean op2High = Definition.mkHigh(false);
		// @security("The returned value has a stronger security level than expected.")
		return op1High && op2High;
	}
	...
	public int expr15() {
		int op1High = Definition.mkHigh(42);
		int op2Low = Definition.mkLow(42);
		// @security("The returned value has a stronger security level than expected.")
	...
	public boolean expr24() {
		boolean op1High = Definition.mkHigh(false);
		boolean op2Low = Definition.mkLow(false);
		// @security("The returned value has a stronger security level than expected.")
		return op1High && op2Low;
	}
	...
	@ReturnSecurity("low")
	public int expr29() {
		int op1Low = Definition.mkLow(42);
		int op2High = Definition.mkHigh(42);
		// @security("The returned value has a stronger security level than expected.")
	...
	public boolean expr38() {
		boolean op1Low = Definition.mkLow(false);
		boolean op2High = Definition.mkHigh(false);
		// @security("The returned value has a stronger security level than expected.")
		return op1Low && op2High;
	}
