...
public class TestDomain {
    ...
    public static TypeDomain<LH.Level>.Type tglb(TypeDomain<LH.Level>.Type l1, TypeDomain<LH.Level>.Type l2) {
        return types.glb(l1, l2);
    }

    public static boolean tle(TypeDomain<LH.Level>.Type l1,TypeDomain<LH.Level>.Type l2) {
