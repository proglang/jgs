 ...
 * 
 * The {@link SecurityLevelSwitch} is the base class for switches which are used for the {@link SecurityLevelAnalysis} analysis. The base
...
abstract public class SecurityLevelSwitch extends SecuritySwitch<LocalsMap> {
	...
	/**
	 * Constructor of a {@link SecurityLevelSwitch} that requires the current incoming and outgoing map of local variables as well as the
	 ...
	 */
	protected SecurityLevelSwitch(AnalyzedMethodEnvironment methodEnvironment, UsedObjectStore store, LocalsMap in, LocalsMap out) {
	 ...
	 * {@link SecurityLevelSwitch#analyzedMethodEnvironment} and the {@link ParameterRef}. Occurring exceptions are logged.
	 * 
	 * @param value
