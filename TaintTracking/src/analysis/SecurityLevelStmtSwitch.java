 ...
 * 
 * The {@link SecurityLevelStmtSwitch} extends the switch
 ...
 * for every possible statement a method that progress the statement, i.e.
 * calculates or updates the <em>security levels</em> of the statement
 * components with the help of other switches. Also the methods check for
 * security violations, such as an invalid return <em>security level</em> of a
 * method, etc. This switch is also responsible for checking whether a implicit
 * flow starts.<br />
 ...
 */
public class SecurityLevelStmtSwitch extends SecurityLevelSwitch implements
        StmtSwitch {

    /**
     * Constructor of a {@link SecurityLevelStmtSwitch} that requires the
     ...
     */
    protected SecurityLevelStmtSwitch(
     ...
     * @see SecurityLevelSwitch#calculateInvokeExprLevel(soot.jimple.InvokeExpr,
     *      boolean)
     */
    @Override
