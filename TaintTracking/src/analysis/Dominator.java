 ...
 * dominator objects. These allow to distinguish the (post-) dominator set for a
 * specific unit. The class provides a method a method that checks whether the
 * post dominator set of a given if-statement contains the second given
 * statement.
 * 
 * <hr />
 * 
...
class Dominator<N> {
    ...
    /**
     * Checks whether the post-dominator set of the given if-statement contains
     * the given statement. I.e. the given statement is a post-dominator of the
     * if-statement.
     * 
     * @param ifStmt
     *            if-statement whose post-dominator set is generated.
     * @param s
     *            statement for which will be checked whether it is contained by
     *            the post-dominator set.
     * @return {@code true} if the post-dominator set of the given if-statement
     *         contains the other given statement, otherwise {@code false}.
     */
