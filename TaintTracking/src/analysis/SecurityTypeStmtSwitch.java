...
/**
 * <h1>Statement switch for the {@link SecurityTypeAnalysis} analysis</h1>
 * 
 * The {@link SecurityTypeStmtSwitch} extends the switch {@link SecurityTypeSwitch} and contains incoming and outgoing locals map of a
 ...
 */
public class SecurityTypeStmtSwitch extends SecurityTypeSwitch implements StmtSwitch {

	/**
	 * Constructor of a {@link SecurityTypeStmtSwitch} that requires the current incoming and outgoing map of local variables as well as the
	 ...
	 */
	protected SecurityTypeStmtSwitch(AnalyzedMethodEnvironment analyzedMethodEnvironment, UsedObjectStore store, LocalsMap in, LocalsMap out) {
	 ...
	 * @see SecurityTypeSwitch#calculateInvokeExprLevel(soot.jimple.InvokeExpr, boolean)
	 */
	@Override
