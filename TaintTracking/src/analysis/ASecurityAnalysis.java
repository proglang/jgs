 ...
 * 
 * The {@link ASecurityAnalysis} is the security analysis and extends the {@link ForwardFlowAnalysis}. The class allows the analysis of
 ...
 * the method {@link ASecurityAnalysis#checkAnalysis()} has to be called.
 * 
 * <hr />
 * 
 * @author Thomas Vogel
...
public abstract class ASecurityAnalysis<N, A> extends ForwardFlowAnalysis<N, A> {
	 ...
	 * <em>security levels</em> for this method. Note, that the method {@link ASecurityAnalysis#checkAnalysis()} has to be called for the
	 ...
	 * @param store
	 */
	protected ASecurityAnalysis(AnalysisLog log, SootMethod sootMethod, ILevelMediator mediator, DirectedGraph<N> graph,
