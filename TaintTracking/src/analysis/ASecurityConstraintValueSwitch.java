...
public abstract class ASecurityConstraintValueSwitch extends
        SecurityConstraintSwitch {
    ...
    private final List<IComponent> equalComponents =
    ...
    protected void throwInvalidWriteException(Value value) {
        throw new SwitchException(getMsg("exception.analysis.switch.invalid_write",
                                         value.toString()));
    }

    protected ASecurityConstraintValueSwitch(
