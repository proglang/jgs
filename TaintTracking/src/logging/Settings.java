 ...
 * 
 * The class {@link Settings} stores specific settings of an analysis. Each single setting provides the setting name as well as the value of
 * this setting. The usage of the class is only for printing the settings via the {@link SootLogger}.
 * 
 * <hr />
 * 
 * @author Thomas Vogel
...
public class Settings implements Serializable {
	 ...
	 * <h1>Setting tuple</h1>
	 * 
	 * The class {@link Setting} represents a tuple that contains the name of a setting as well as the value of this setting. Thus the class
	 * is a simple representation of a specific setting and will be used for printing the setting of the analysis.
	 * 
	 * <hr />
	 * 
	 * @author Thomas Vogel
	...
	public static class Setting implements Serializable {
		...
		/**
		 * The constructor of a setting tuple which provides the name of a specific setting as well as the value of this setting.
		 * 
		 * @param name
		 *          Name of the setting.
		 * @param value
	...
	/**
	 * Constructor of a complete setting, which can contain multiple specific setting tuples. Each such a setting provides a setting name and
	 * its value.
	 * 
	 * @param settings
	...
	/**
	 * Method returns all configuration tuples contained by this {@link Settings} instance. These tuples were given to the constructor.
	 * 
