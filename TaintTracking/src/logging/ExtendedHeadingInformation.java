 ...
 * 
 * The class {@link ExtendedHeadingInformation} provides the informations how many tabs should be inserted in front of an heading as well as
 * the file name and the source line number which are related to the heading. The class {@link ExtendedHeadingInformation} extends the
 * normal heading information class {@link HeadingInformation}, to store all additional required information. These informations are
 * necessary for all kinds of {@link SootLogger} and also for the corresponding LoggerFormatter.
 * 
 * <hr />
 * 
 * @author Thomas Vogel
...
public class ExtendedHeadingInformation extends HeadingInformation {
	...
	/**
	 * Constructor of the ExtendedHeadingInformation which stores the informations how many tabs should be inserted in front of a heading as
	 * well as the source line number and the file name which are related to the heading.
	 * 
	 * @param tabs
