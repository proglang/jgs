 ...
 * {@link IfStmt}.<br />
 * The {@link LocalsMap} will be used in the {@link TaintTracking} analysis as
 * flow object.
 * 
 * <hr />
 * 
...
public class LocalsMap {
	 ...
	 * 
	 * The {@link ExtendedLocal} encapsulates a {@link Local} object and extends
	...
	public static class ExtendedLocal {
		...
		/**
		 * Constructor of an {@link ExtendedLocal} for a given {@link Local},
		...
		/**
		 * Constructor of an {@link ExtendedLocal} for a given {@link Local},
		 * that should be encapsulated and it corresponding
		 * <em>security level</em>. I.e. given <em>security level</em> is the
		 * level of the given {@link Local}.
		 * 
		 * @param local
		 *            The {@link Local} which should be
		 *            {@link EncapsulatedMethodAnalysis} by created
		 ...
		 *            {@link ExtendedLocal} should be set.
		 */
	 ...
	 * {@link ExtendedLocal} of the given collection doesn't has an
	 ...
	 * @see ExtendedLocal
	 */
	public void addAll(Collection<ExtendedLocal> locals,
			Map<IfStmt, String> programCounter) {
	...
	/**
	 * Method which takes a list of {@link ExtendedLocal} and updates every
	 ...
	 * {@link ExtendedLocal} is stronger than the <em>security level</em> of the
	 ...
	 * 
	 * @param locals
	 *            List of {@link ExtendedLocal} whose <em>security levels</em>
	...
	/**
	 * Creates a list of {@link ExtendedLocal} that contains all contained
	 * locals of {@link LocalsMap#localMap} together with their corresponding
	 * <em>security level</em>.
	 * 
	 * @return List of all contained {@link Local}s of this map as
	 *         {@link ExtendedLocal} including the corresponding
	 *         <em>security level</em>.
	 */
	 ...
	 * {@link ExtendedLocal}. Note, that none {@link ExtendedLocal} has a
	 * <em>security level</em> after this conversion.
	 * 
	 * @param locals
	 *            List of {@link Local} which should be converted.
	 * @return A list of {@link ExtendedLocal} that contains those {@link Local}
