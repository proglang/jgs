 ...
 * 
 * The {@link Effect} represents a calculated effect to a
 * <em>security level</em> which occurs at a specific source line number inside
 * of a analyzed method. Each effect has also a cause that indicates why this
 * effect has occurred, or from where this effect was inherited.
 * 
 * <hr />
 * 
 * @author Thomas Vogel
...
public class Effect {
    ...
    /**
     * Constructor of an {@link Effect} that requires the effected
     * <em>security level</em>, the source line number at which the effect
     * occurs and also a cause why this effect occurs.
     * 
     * @param effected
     ...
     * @param cause
     *            Subclass of {@link Cause} which specifies the reason of this
     *            effect.
     */
    ...
    /**
     * Returns a subclass of {@link Cause} which represents the reason of the
     * effect.
     * 
