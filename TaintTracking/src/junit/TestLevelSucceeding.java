...
public class TestLevelSucceeding {
    ...
    private static final TestFile ID = new TestFile(TEST_PACKAGE,
                                                    "SuccessIdFunctions");
    private static final TestFile IFELSE = new TestFile(TEST_PACKAGE,
                                                        "SuccessIfElse");
    private static final TestFile LOOP = new TestFile(TEST_PACKAGE,
                                                      "SuccessLoop");
    ...
    private static final TestFile STATIC_FIELD =
        new TestFile(TEST_PACKAGE, "SuccessStaticField");
    private static final TestFile STATIC_METHOD =
        new TestFile(TEST_PACKAGE, "SuccessStaticMethod");
