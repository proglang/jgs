...
public class TestSootUtils {
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        VisibilityAnnotationTag visibilityAnnotationTagC1 =
            new VisibilityAnnotationTag(0);
        AnnotationTag annotationTagC1 =
            new AnnotationTag("Ltest/AnnotationString;", 1);
        AnnotationStringElem annotationStringElemC1 =
            new AnnotationStringElem("Test String Annotation",
                                     "s".charAt(0),
                                     "String Annotation");
        ...
        sootMethod5C1 =
            new SootMethod("method5",
                           new ArrayList<Object>(Arrays.asList(new RefType[] {
                                                                              INT,
                                                                              BOOL })),
                           BOOL,
                           PROTECTED);
        ...
        sootMethod7C1 =
            new SootMethod("method7", new ArrayList<Object>(), INT_ARR, PRIVATE);
        ...
        VisibilityAnnotationTag visibilityAnnotationTagC2 =
            new VisibilityAnnotationTag(0);
        AnnotationTag annotationTagC2 =
            new AnnotationTag("Ltest/AnnotationStringArray;", 1);
        AnnotationStringElem annotationStringElem1C2 =
            new AnnotationStringElem("Test String Annotation 1",
                                     "s".charAt(0),
                                     "String Annotation");
        AnnotationStringElem annotationStringElem2C2 =
            new AnnotationStringElem("Test String Annotation 2",
                                     "s".charAt(0),
                                     "String Annotation");
        AnnotationArrayElem annotationArrayElemC2 =
            new AnnotationArrayElem(new ArrayList<AnnotationElem>(Arrays.asList(new AnnotationElem[] {
                                                                                                      annotationStringElem1C2,
                                                                                                      annotationStringElem2C2 })),
                                    "[".charAt(0),
                                    "String Array Annotation");
    ...
    public final void testGenerateFileNameSootClass() {
        assertTrue("Correct file name for class1",
                   generateFileName(sootClass1).equals("TestC1"));
        assertTrue("Correct file name for class2",
                   generateFileName(sootClass2).equals("TestC2"));
    }

    @Test
    public final void testGenerateFileNameSootMethod() {
        assertTrue("Correct file name for method1 of class1.",
                   generateFileName(sootMethod1C1).equals("TestC1"));
        assertTrue("Correct file name for method1 of class2.",
                   generateFileName(sootMethod1C2).equals("TestC2"));
        assertTrue("Correct file name for method2 of class1.",
                   generateFileName(sootMethod2C1).equals("TestC1"));
        assertTrue("Correct file name for method2 of class2.",
                   generateFileName(sootMethod2C2).equals("TestC2"));
        assertTrue("Correct file name for method3 of class1.",
                   generateFileName(sootMethod3C1).equals("TestC1"));
        assertTrue("Correct file name for method3 of class2.",
                   generateFileName(sootMethod3C2).equals("TestC2"));
        assertTrue("Correct file name for method4 of class1.",
                   generateFileName(sootMethod4C1).equals("TestC1"));
        assertTrue("Correct file name for method4 of class2.",
                   generateFileName(sootMethod4C2).equals("TestC2"));
        assertTrue("Correct file name for method5 of class1.",
                   generateFileName(sootMethod5C1).equals("TestC1"));
        assertTrue("Correct file name for method5 of class2.",
                   generateFileName(sootMethod5C2).equals("TestC2"));
        assertTrue("Correct file name for method6 of class1.",
                   generateFileName(sootMethod6C1).equals("TestC1"));
        assertTrue("Correct file name for method6 of class2.",
                   generateFileName(sootMethod6C2).equals("TestC2"));
        assertTrue("Correct file name for method7 of class1.",
                   generateFileName(sootMethod7C1).equals("TestC1"));
        assertTrue("Correct file name for method7 of class2.",
                   generateFileName(sootMethod7C2).equals("TestC2"));
        assertTrue("Correct file name for unknown method of unknown class.",
                   generateFileName(new SootClass("unknown")).equals("unknown"));
    }
    ...
    public final void testGenerateLevelFunctionName() {
        ...
        assertTrue("Correct level function name",
                   generateLevelFunctionName(l1).equals("mkHigh"));
        ...
        assertTrue("Correct level function name",
                   generateLevelFunctionName(l2).equals("mkLow"));
    }

    @Test
    public final void testIsClinitMethod() {
        assertTrue("Method1 of class1 isn't a clinit.",
                   !isClinitMethod(sootMethod1C1));
        assertTrue("Method1 of class2 isn't a clinit.",
                   !isClinitMethod(sootMethod1C2));
        assertTrue("Method2 of class1 isn't a clinit.",
                   !isClinitMethod(sootMethod2C1));
        assertTrue("Method2 of class2 isn't a clinit.",
                   !isClinitMethod(sootMethod2C2));
        assertTrue("Method3 of class1 isn't a clinit.",
                   !isClinitMethod(sootMethod3C1));
        assertTrue("Method3 of class2 isn't a clinit.",
                   !isClinitMethod(sootMethod3C2));
        assertTrue("Method4 of class1 isn't a clinit.",
                   !isClinitMethod(sootMethod4C1));
        assertTrue("Method4 of class2 isn't a clinit.",
                   !isClinitMethod(sootMethod4C2));
        assertTrue("Method5 of class1 isn't a clinit.",
                   !isClinitMethod(sootMethod5C1));
        assertTrue("Method5 of class2 isn't a clinit.",
                   !isClinitMethod(sootMethod5C2));
        assertTrue("Method6 of class1 isn't a clinit.",
                   !isClinitMethod(sootMethod6C1));
        assertTrue("Method6 of class2 isn't a clinit.",
                   !isClinitMethod(sootMethod6C2));
        assertTrue("Method7 of class1 isn't a clinit.",
                   !isClinitMethod(sootMethod7C1));
        assertTrue("Method7 of class2 isn't a clinit.",
                   !isClinitMethod(sootMethod7C2));
        SootMethod clinit =
    ...
    public final void testIsInitMethod() {
        assertTrue("Method1 of class1 isn't a init.",
                   !isInitMethod(sootMethod1C1));
        assertTrue("Method1 of class2 isn't a init.",
                   !isInitMethod(sootMethod1C2));
        assertTrue("Method2 of class1 isn't a init.",
                   !isInitMethod(sootMethod2C1));
        assertTrue("Method2 of class2 isn't a init.",
                   !isInitMethod(sootMethod2C2));
        assertTrue("Method3 of class1 isn't a init.",
                   !isInitMethod(sootMethod3C1));
        assertTrue("Method3 of class2 isn't a init.",
                   !isInitMethod(sootMethod3C2));
        assertTrue("Method4 of class1 isn't a init.",
                   !isInitMethod(sootMethod4C1));
        assertTrue("Method4 of class2 isn't a init.",
                   !isInitMethod(sootMethod4C2));
        assertTrue("Method5 of class1 isn't a init.",
                   !isInitMethod(sootMethod5C1));
        assertTrue("Method5 of class2 isn't a init.",
                   !isInitMethod(sootMethod5C2));
        assertTrue("Method6 of class1 isn't a init.",
                   !isInitMethod(sootMethod6C1));
        assertTrue("Method6 of class2 isn't a init.",
                   !isInitMethod(sootMethod6C2));
        assertTrue("Method7 of class1 isn't a init.",
                   !isInitMethod(sootMethod7C1));
        assertTrue("Method7 of class2 isn't a init.",
                   !isInitMethod(sootMethod7C2));
        SootMethod init =
            new SootMethod(constructorName,
                           new ArrayList<Object>(Arrays.asList(new RefType[] {
                                                                              INT,
                                                                              BOOL })),
                           VOID,
