...
public class TestConstraints {
	...
	public final void testContainsParameterRef() {
		...
		cons5.add(rr);
		cons5.add(rp2);
		assertTrue("Constraints object with 2 constraint containing parameter references",
				cons5.containsParameterRef());
	}
	...
	public final void testGetContainedParameterRefs() {
		...
		assertTrue("Constraints object without constraints which contains parameter references",
				cons2.getContainedParameterRefs()
				.equals(new HashSet<ConstraintParameterRef>(Arrays.asList(new ConstraintParameterRef[] {}))));
		Constraints cons3 = new Constraints();
		cons3.add(l1l2);
		cons3.add(rp2);
		assertTrue("Constraints object with 1 constraint containing parameter references",
				cons3.getContainedParameterRefs()
				.equals(new HashSet<ConstraintParameterRef>(Arrays.asList(new ConstraintParameterRef[] {paramRef2}))));
		Constraints cons4 = new Constraints();
		cons4.add(rp2);
		cons4.add(l1p1);
		assertTrue("Constraints object with 2 constraint containing parameter references",
				cons4.getContainedParameterRefs()
				.equals(new HashSet<ConstraintParameterRef>(Arrays.asList(new ConstraintParameterRef[] {paramRef1, paramRef2}))));
		Constraints cons5 = new Constraints();
		cons5.add(rp2);
		cons5.add(l1l2);
		cons5.add(l1r);
		cons5.add(p2p1);
		assertTrue("Constraints object with 2 constraint containing parameter references",
				cons5.getContainedParameterRefs()
				.equals(new HashSet<ConstraintParameterRef>(Arrays.asList(new ConstraintParameterRef[] {paramRef1, paramRef2}))));
	}
	...
	public final void testGetContainedLevels() {		
		Constraints cons1 = new Constraints();
		assertTrue("Empty constraints object without constraints which contains levels", cons1.getContainedLevels()
				.equals(new HashSet<ILevel>(Arrays.asList(new ILevel[] {}))));
		Constraints cons2 = new Constraints();
		cons2.add(rr);
		assertTrue("Constraints object without constraints which contains levels",
				cons2.getContainedLevels()
				.equals(new HashSet<ILevel>(Arrays.asList(new ILevel[] {}))));
		Constraints cons3 = new Constraints();
		cons3.add(l1l2);
		cons3.add(rp2);
		assertTrue("Constraints object with 1 constraint containing levels",
				cons3.getContainedLevels()
				.equals(new HashSet<ILevel>(Arrays.asList(new ILevel[] {level1,level2}))));
		Constraints cons4 = new Constraints();
		cons4.add(rp2);
		cons4.add(l1p1);
		assertTrue("Constraints object with 1 constraint containing levels",
				cons4.getContainedLevels()
				.equals(new HashSet<ILevel>(Arrays.asList(new ILevel[] {level1}))));
		Constraints cons5 = new Constraints();
		cons5.add(rp2);
		cons5.add(l1l2);
		cons5.add(l1r);
