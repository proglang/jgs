...
public class TestConstraints {
	...
	private IConstraintComponent pc = new ConstraintProgramCounterRef("a");
	...
	public final void testRemoveConstraintsContaining3() {
		...
		Set<IConstraint> l1 = mkList(new IConstraint[] { ra_h, new LEQConstraint(par1b, new ConstraintLocal(lb)), l_h, p0a_p1a});
		c1.addAllSmart(l1);
		c1.removeConstraintsContaining(la);
		assertTrue(equalContentOfLists(c1.getConstraintsSet(), l1));
	}
	...
	public final void testRemoveConstraintsContaining4() {
		...
		c1.removeConstraintsContaining(la);
		assertTrue(equalContentOfLists(c1.getConstraintsSet(), mkList(new IConstraint[] { ra_h, l_h, p0a_p1a, new LEQConstraint(new ConstraintLocal(lb), pc) })));
	}
