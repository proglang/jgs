...
import static constraints.AConstraint.isLevel;
import static constraints.AConstraint.isParameterRef;
import static constraints.AConstraint.isReturnRef;
...
public class TestConstraint {
	...
	public final void testIsLevel() {
		...
		assertTrue("Component is not a security level", !isLevel(paramRef1));
		assertTrue("Component is not a security level", !isLevel(paramRef2));
		assertTrue("Component is not a security level", !isLevel(returnRef));
	}
	...
	public final void testIsParameterRef() {
		...
		assertTrue("Component is not a parameter reference", !isParameterRef(level1));
		assertTrue("Component is not a parameter reference", !isParameterRef(level2));
		assertTrue("Component is not a parameter reference", !isParameterRef(returnRef));
	}

	@Test
	public final void testIsReturnRef() {
		assertTrue("Component is a return reference", isReturnRef(returnRef));
		assertTrue("Component is not a return reference", !isReturnRef(level1));
		assertTrue("Component is not a return reference", !isReturnRef(level2));
		assertTrue("Component is not a return reference", !isReturnRef(paramRef1));
		assertTrue("Component is not a return reference", !isReturnRef(paramRef2));
	}
