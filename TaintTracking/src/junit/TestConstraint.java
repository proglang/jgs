...
public class TestConstraint {
    ...
    private ComponentProgramCounterRef pca =
        new ComponentProgramCounterRef("a");
    ...
    public final void testContainsSetParameterReference() {
        ...
        assertTrue(containsSetParameterReference(mkList(new LEQConstraint[] {
                                                                             p0a_h,
                                                                             l_pc })));
        assertTrue(containsSetParameterReference(mkList(new LEQConstraint[] {
                                                                             l_pc,
    ...
    public final void testContainsSetParameterReferenceFor() {
        assertTrue(containsSetParameterReferenceFor(mkList(new LEQConstraint[] { p0a_h }),
                                                    "a",
                                                    0));
        assertTrue(containsSetParameterReferenceFor(mkList(new LEQConstraint[] {
                                                                                p0a_h,
                                                                                l_pc }),
                                                    "a",
                                                    0));
        assertTrue(containsSetParameterReferenceFor(mkList(new LEQConstraint[] {
                                                    ...
                                                    "a",
                                                    1));
        assertFalse(containsSetParameterReferenceFor(mkList(new LEQConstraint[] { p0a_h }),
                                                     "b",
                                                     0));
        assertFalse(containsSetParameterReferenceFor(mkList(new LEQConstraint[] {
                                                                                 p0a_h,
                                                                                 l_pc }),
                                                     "a",
                                                     1));
    ...
    public final void testContainsSetProgramCounterReference() {
        ...
        assertTrue(containsSetProgramCounterReference(mkList(new LEQConstraint[] {
                                                                                  p0a_h,
                                                                                  l_pc })));
        assertTrue(containsSetProgramCounterReference(mkList(new LEQConstraint[] {
                                                                                  l_pc,
    ...
    public final void testContainsSetReturnReference() {
        ...
        assertTrue(containsSetReturnReference(mkList(new LEQConstraint[] {
                                                                          p0a_h,
                                                                          ra_pc })));
        assertTrue(containsSetReturnReference(mkList(new LEQConstraint[] {
                                                                          p0a_ra,
    ...
    public final void testContainsSetReturnReferenceFor() {
        assertTrue(containsSetReturnReferenceFor(mkList(new LEQConstraint[] { ra_h }),
                                                 "a"));
        assertTrue(containsSetReturnReferenceFor(mkList(new LEQConstraint[] {
                                                                             ra_pc,
                                                                             h_l }),
                                                 "a"));
        assertTrue(containsSetReturnReferenceFor(mkList(new LEQConstraint[] {
                                                                             ...
                                                                             p0a_ra }),
                                                 "a"));
        assertFalse(containsSetReturnReferenceFor(mkList(new LEQConstraint[] { ra_h }),
                                                  "b"));
        assertFalse(containsSetReturnReferenceFor(mkList(new LEQConstraint[] {
                                                                              p0a_h,
                                                                              ra_h }),
                                                  "b"));
        assertFalse(containsSetReturnReferenceFor(mkList(new LEQConstraint[] {
    ...
    public final void testGetContainedLevelsOfSet() {
        assertTrue(equalContentOfLists(getContainedLevelsOfSet(mkList(new LEQConstraint[] {})),
                                       mkList(new ILevel[] {})));
        assertTrue(equalContentOfLists(getContainedLevelsOfSet(mkList(new LEQConstraint[] { ra_pc })),
                                       mkList(new ILevel[] {})));
        assertTrue(equalContentOfLists(getContainedLevelsOfSet(mkList(new LEQConstraint[] { ra_h })),
                                       mkList(new ILevel[] { high })));
        assertTrue(equalContentOfLists(getContainedLevelsOfSet(mkList(new LEQConstraint[] {
                                                                                           ra_h,
                                                                                           p1a_h })),
                                       mkList(new ILevel[] { high })));
    ...
    public final void testGetInvalidParameterReferencesOfSet() {
        assertTrue(equalContentOfLists(getInvalidParameterReferencesOfSet(mkList(new LEQConstraint[] {}),
                                                                          "a",
                                                                          0,
                                                                          mkIntList()),
                                       mkList(new IComponent[] {})));
        assertTrue(equalContentOfLists(getInvalidParameterReferencesOfSet(mkList(new LEQConstraint[] { p1a_h }),
                                                                          "a",
                                                                          1,
                                                                          mkIntList(0)),
    ...
    public final void testGetInvalidReturnReferencesOfSet() {
        assertTrue(equalContentOfLists(getInvalidReturnReferencesOfSet(mkList(new LEQConstraint[] {}),
                                                                       "a",
                                                                       0),
                                       mkList(new IComponent[] {})));
        assertTrue(equalContentOfLists(getInvalidReturnReferencesOfSet(mkList(new LEQConstraint[] { ra_pc }),
                                                                       "a",
                                                                       0),
                                       mkList(new IComponent[] {})));
        assertTrue(equalContentOfLists(getInvalidReturnReferencesOfSet(mkList(new LEQConstraint[] { ra_pc }),
    ...
    public final void testContainsLevel() {
        assertTrue(equalContentOfLists(p0a_h.getContainedLevel(),
                                       mkList(new ILevel[] { high })));
        assertTrue(equalContentOfLists(l_h.getContainedLevel(),
                                       mkList(new ILevel[] { high, low })));
        assertTrue(equalContentOfLists(l_p0a.getContainedLevel(),
                                       mkList(new ILevel[] { low })));
        assertTrue(equalContentOfLists(p0a_p1a.getContainedLevel(),
                                       mkList(new ILevel[] {})));
        assertTrue(equalContentOfLists(ra_pc.getContainedLevel(),
                                       mkList(new ILevel[] {})));
    }
    ...
    public final void testGetInvalidParameterReferencesFor() {
        assertTrue(equalContentOfLists(p0a_h.getInvalidParameterReferencesFor("a",
                                                                              0,
                                                                              mkIntList()),
                                       mkList(new IComponent[] { par0a })));
        assertTrue(equalContentOfLists(p0a_h.getInvalidParameterReferencesFor("a",
                                                                              1,
                                                                              mkIntList(0)),
                                       mkList(new IComponent[] {})));
        assertTrue(equalContentOfLists(ap0a_ra.getInvalidParameterReferencesFor("a",
                                                                                1,
                                                                                mkIntList(0)),
                                       mkList(new IComponent[] { apar0a })));
        assertTrue(equalContentOfLists(ap0a_ra.getInvalidParameterReferencesFor("b",
                                                                                1,
                                                                                mkIntList(0)),
                                       mkList(new IComponent[] { apar0a })));
        assertTrue(equalContentOfLists(ap0a_ra.getInvalidParameterReferencesFor("a",
        ...
        assertTrue(equalContentOfLists(ap0a_ra.getInvalidParameterReferencesFor("a",
                                                                                ...
                                                                                mkIntList(1)),
                                       mkList(new IComponent[] {})));
        assertTrue(equalContentOfLists(p0a_p1a.getInvalidParameterReferencesFor("a",
                                                                                0,
                                                                                mkIntList()),
                                       mkList(new IComponent[] { par0a, par1a })));
        assertTrue(equalContentOfLists(p0a_p1a.getInvalidParameterReferencesFor("a",
                                                                                1,
                                                                                mkIntList(0)),
                                       mkList(new IComponent[] { par1a })));
        assertTrue(equalContentOfLists(p0a_p1a.getInvalidParameterReferencesFor("a",
                                                                                ...
                                                                                mkIntList(0,
                                                                                          0)),
                                       mkList(new IComponent[] {})));
        assertTrue(equalContentOfLists(p0a_p1a.getInvalidParameterReferencesFor("b",
                                                                                0,
                                                                                mkIntList()),
                                       mkList(new IComponent[] { par0a, par1a })));
        assertTrue(equalContentOfLists(p0a_p1a.getInvalidParameterReferencesFor("b",
                                                                                ...
                                                                                mkIntList(0,
                                                                                          0)),
                                       mkList(new IComponent[] { par0a, par1a })));
        assertTrue(equalContentOfLists(l_h.getInvalidParameterReferencesFor("a",
                                                                            3,
                                                                            mkIntList(0,
                                                                                      0,
                                                                                      0)),
                                       mkList(new IComponent[] {})));
        assertTrue(equalContentOfLists(ra_pc.getInvalidParameterReferencesFor("b",
                                                                              0,
                                                                              mkIntList()),
                                       mkList(new IComponent[] {})));
    }
    ...
    public final void testGetInvalidReturnReferencesFor() {
        assertTrue(equalContentOfLists(ra_pc.getInvalidReturnReferencesFor("a",
                                                                           0),
                                       mkList(new IComponent[] {})));
        assertTrue(equalContentOfLists(ra_pc.getInvalidReturnReferencesFor("b",
                                                                           0),
                                       mkList(new IComponent[] { reta })));
        assertTrue(equalContentOfLists(ara_pc.getInvalidReturnReferencesFor("b",
                                                                            0),
                                       mkList(new IComponent[] { areta })));
        assertTrue(equalContentOfLists(ara_pc.getInvalidReturnReferencesFor("a",
                                                                            0),
                                       mkList(new IComponent[] { areta })));
        assertTrue(equalContentOfLists(ara_pc.getInvalidReturnReferencesFor("b",
                                                                            1),
        ...
        assertTrue(equalContentOfLists(ara_pc.getInvalidReturnReferencesFor("a",
                                                                            1),
                                       mkList(new IComponent[] {})));
        assertTrue(equalContentOfLists(p1a_ra.getInvalidReturnReferencesFor("a",
                                                                            0),
                                       mkList(new IComponent[] {})));
        assertTrue(equalContentOfLists(p1a_ra.getInvalidReturnReferencesFor("b",
                                                                            0),
                                       mkList(new IComponent[] { reta })));
        assertTrue(equalContentOfLists(p0a_h.getInvalidReturnReferencesFor("a",
                                                                           0),
                                       mkList(new IComponent[] {})));
        assertTrue(equalContentOfLists(p0a_p1a.getInvalidReturnReferencesFor("a",
                                                                             0),
                                       mkList(new IComponent[] {})));
        assertTrue(equalContentOfLists(l_h.getInvalidReturnReferencesFor("a", 0),
                                       mkList(new IComponent[] {})));
    }
