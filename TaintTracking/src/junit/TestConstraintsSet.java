...
public class TestConstraintsSet {
    ...
    private static Set<LEQConstraint> EMPTY_CONSTRAINT_LIST =
        mkList(new LEQConstraint[] {});
    ...
    public final void testGetTransitiveClosure1() {
        assertTrue(equalContentOfLists(c1.getConstraintsSet(),
                                       EMPTY_CONSTRAINT_LIST));

        c1.add(p0a_p1a);
        ConstraintsSet c2 = c1.getTransitiveClosure();
        assertTrue(equalContentOfLists(c2.getConstraintsSet(),
                                       mkList(new LEQConstraint[] { p0a_p1a })));

        c1.add(l_p0a);
        ConstraintsSet c3 = c1.getTransitiveClosure();
        assertTrue(equalContentOfLists(c3.getConstraintsSet(),
                                       mkList(new LEQConstraint[] { p0a_p1a,
                                                                   l_p0a, l_p1a })));

        c1.add(ra_h);
        ConstraintsSet c4 = c1.getTransitiveClosure();
        assertTrue(equalContentOfLists(c4.getConstraintsSet(),
                                       mkList(new LEQConstraint[] { p0a_p1a,
                                                                   l_p0a,
                                                                   l_p1a, ra_h })));
        ...
        assertTrue(equalContentOfLists(c5.getConstraintsSet(),
                                       mkList(new LEQConstraint[] { p0a_p1a,
                                                                   l_p0a,
                                                                   l_p1a, ra_h,
                                                                   ra_pc })));
        ...
        assertTrue(equalContentOfLists(c6.getConstraintsSet(),
                                       mkList(new LEQConstraint[] { p0a_p1a,
                                                                   l_p0a,
                                                                   l_p1a, ra_h,
                                                                   ra_pc,
    ...
    public final void testGetTransitiveClosure2() {
        ...
        ConstraintsSet c2 = c1.getTransitiveClosure();
        assertTrue(equalContentOfLists(c2.getConstraintsSet(),
                                       mkList(new LEQConstraint[] { l_p0a })));
    ...
    public final void testGetInequations1() {
        ...
        assertTrue(equalContentOfLists(c1.getInconsistent(),
                                       EMPTY_CONSTRAINT_LIST));
    ...
    public final void testRemoveConstraintsContainingReferencesFor2() {
        ...
        Set<LEQConstraint> l1 =
            mkList(new LEQConstraint[] { p1a_h, ra_h, l_h, l_pc });
        c1.addAll(l1);
        c1.removeConstraintsContainingReferencesFor("b");
    ...
    public final void testRemoveConstraintsContainingReferencesFor3() {
        ...
        c1.addAll(mkList(new LEQConstraint[] { p1a_h,
                                              new LEQConstraint(low, retb),
                                              ra_h, l_h, l_pc }));
        c1.removeConstraintsContainingReferencesFor("b");
        assertTrue(equalContentOfLists(c1.getConstraintsSet(),
                                       mkList(new LEQConstraint[] { p1a_h,
                                                                   ra_h, l_h,
                                                                   l_pc })));
    }
    ...
    public final void testRemoveConstraintsContainingReferencesFor4() {
        ...
        c1.addAll(mkList(new LEQConstraint[] { p1a_h, ra_h,
                                              new LEQConstraint(par1b, high),
                                              l_h, l_pc }));
        c1.removeConstraintsContainingReferencesFor("b");
        assertTrue(equalContentOfLists(c1.getConstraintsSet(),
                                       mkList(new LEQConstraint[] { p1a_h,
    ...
    public final void testRemoveConstraintsContaining2() {
        ...
        Set<LEQConstraint> l1 =
            mkList(new LEQConstraint[] { ra_h, l_h, p0a_p1a });
        c1.addAll(l1);
        c1.removeConstraintsContaining(new ComponentLocal(local_a));
        assertTrue(equalContentOfLists(c1.getConstraintsSet(), l1));
    }
    ...
    public final void testRemoveConstraintsContaining3() {
        ...
        Set<LEQConstraint> l1 =
            mkList(new LEQConstraint[] {
                                        ra_h,
                                        new LEQConstraint(par1b,
                                                          new ComponentLocal(local_b)),
                                        l_h, p0a_p1a });
        c1.addAll(l1);
        c1.removeConstraintsContaining(new ComponentLocal(local_a));
        assertTrue(equalContentOfLists(c1.getConstraintsSet(), l1));
    ...
    public final void testRemoveConstraintsContaining4() {
        ...
        c1.addAll(mkList(new LEQConstraint[] {
                                              ra_h,
                                              new LEQConstraint(par1a,
                                                                new ComponentLocal(local_a)),
                                              l_h,
                                              p0a_p1a,
                                              new LEQConstraint(new ComponentLocal(local_b),
                                                                pca) }));
        c1.removeConstraintsContaining(new ComponentLocal(local_a));
        assertTrue(equalContentOfLists(c1.getConstraintsSet(),
                                       mkList(new LEQConstraint[] {
    ...
    public final void testRemoveConstraintsContaining5() {
        ...
        c1.removeConstraintsContaining(new ComponentLocal(local_a));
        assertTrue(equalContentOfLists(c1.getConstraintsSet(),
                                       mkList(new LEQConstraint[] { ra_h, l_h,
                                                                   p0a_p1a })));
    }
    ...
    public final void testRemoveConstraintsContaining6() {
        ...
        c1.addAll(mkList(new LEQConstraint[] {
                                              ra_h,
                                              new LEQConstraint(new ComponentLocal(local_a),
                                                                par1b),
                                              l_h,
                                              p0a_p1a,
                                              new LEQConstraint(new ComponentLocal(local_a),
