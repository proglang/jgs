...
public class TestSecurityAnnotation {
	...
	// SootMethod sootM3 = new SootMethod("lowId", Arrays.asList(new Type[] {RefType.v(), RefType.v()}), RefType.v(), Modifier.PUBLIC |
	// Modifier.STATIC);
	// sootM3.setDeclaringClass(sootC1);
	// sootC1.addMethod(sootM3);
	// assertTrue("Method 'public static <T> T lowId(T,T)' isn't an id function.", ! securityAnnotation.isIdFunction(sootM3));
	// SootMethod sootM4 = new SootMethod("helloDavId", Arrays.asList(new Type[] {RefType.v()}), RefType.v(), Modifier.PUBLIC |
	// Modifier.STATIC);
