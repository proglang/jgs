...
public class TestComponent {
	...
	public final void testEqualsLevel() {
		...
		assertFalse("Not equal levels", level1.equals(new ComponentParameterRef(0, "test")));
	}
	...
	public final void testEqualsParamRef() {
		...
		assertTrue("Equal param refs", p1.equals(new ComponentParameterRef(0, "test")));
		assertTrue("Equal param refs", new ComponentParameterRef(0, "test").equals(p1));
		...
		assertFalse("Not equal param refs", p1.equals(new ComponentParameterRef(0, "testb")));
		assertFalse("Not equal param refs", new ComponentParameterRef(1, "test").equals(p1));
	}
	...
	public final void testEqualsReturnRef() {
		...
		assertTrue("Equal return refs", r1.equals(new ComponentReturnRef("test")));
		assertTrue("Equal return refs", new ComponentReturnRef("test").equals(r1));
		...
		assertFalse("Not equal return refs", r1.equals(new ComponentReturnRef("testb")));
		assertFalse("Not equal return refs", new ComponentReturnRef("testb").equals(r1));
	}
	...
	public final void testEqualsPCRef() {
		...
		assertTrue("Equal pc refs", pc1.equals(new ComponentProgramCounterRef("a")));
		assertTrue("Equal pc refs", new ComponentProgramCounterRef("a").equals(pc1));
