...
public class TestAnalysisSucceeding {
	...
	public final void test01Valid() {
		checkMethodStoreEquality(VALID01, CHECK_LEVELS);
	}

	@Test
	public final void test02Valid() {
		checkMethodStoreEquality(VALID02, CHECK_LEVELS);
	}

	@Test
	public final void test03Valid() {
		checkMethodStoreEquality(VALID03, CHECK_LEVELS);
	}

	@Test
	public final void test04Valid() {
		checkMethodStoreEquality(VALID04, CHECK_LEVELS);
	}

	@Test
	public final void test05Valid() {
		checkMethodStoreEquality(VALID05, CHECK_LEVELS);
	}

	@Test
	public final void test06Valid() {
		checkMethodStoreEquality(VALID06, CHECK_LEVELS);
	}

	@Test
	public final void test07Valid() {
		checkMethodStoreEquality(VALID07, CHECK_LEVELS);
	}
	...
	public final void test17IfElse() {
		checkMethodStoreEquality(IFELSE, CHECK_LEVELS);
	}
