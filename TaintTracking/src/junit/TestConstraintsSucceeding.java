...
public class TestConstraintsSucceeding {
	...
	private static final TestFile METHOD_INSTANCE = new TestFile(TEST_PACKAGE, "SuccessMethodInstance");
	private static final TestFile METHOD_STATIC = new TestFile(TEST_PACKAGE, "SuccessMethodStatic");
	...
	private static final TestFile WHILE = new TestFile(TEST_PACKAGE, "SuccessWhile");
	private static final TestFile ARRAY = new TestFile(TEST_PACKAGE, "SuccessArray");
	private static final TestFile INHERITANCE = new TestFile(TEST_PACKAGE, "SuccessInheritance");
	private static final TestFile EFFECT = new TestFile(TEST_PACKAGE, "SuccessWriteEffect");
	private static final TestFile SPECIAL_01 = new TestFile(TEST_PACKAGE, "SuccessSpecial01");
	private static final TestFile SPECIAL_02 = new TestFile(TEST_PACKAGE, "SuccessSpecial02");
	private static final TestFile SPECIAL_03 = new TestFile(TEST_PACKAGE, "SuccessSpecial03");
