 ...
 * {@link JUnitSootSecurityLevelImplementation1},
 * {@link JUnitSootSecurityLevelImplementation2},
 * {@link JUnitSootSecurityLevelImplementation3} and
 * {@link JUnitSootSecurityLevelImplementation4} represents (in-) valid test
 * classes which will be checked by the {@link SecurityLevelImplChecker}.
 * 
 * <hr />
 * 
 * @author Thomas Vogel
...
public class TestSecurityLevelImplChecker {
    ...
    // private static SecurityLevelImplChecker getChecker(SecurityLevel
    // securityLevel,
    // boolean throwException) throws SecurityLevelException {
    // SecurityLevelImplChecker checker = null;
    // try {
    // Constructor<SecurityLevelImplChecker> constructor =
    // SecurityLevelImplChecker.class
    // .getDeclaredConstructor(SecurityLogger.class, SecurityLevel.class,
    // boolean.class, boolean.class);
    // constructor.setAccessible(true);
    // checker = constructor.newInstance(null, securityLevel, false,
    // throwException);
    // } catch (SecurityLevelException | SecurityException |
    ...
    // JUnitSootSecurityLevelImplementation2 impl = new
    // JUnitSootSecurityLevelImplementation2();
    // SecurityLevelImplChecker checker = null;
    // try {
    ...
    // String expectedLevel = new String[] { "void", "1*", "high", "normal",
    // "low", "h()" }[i];
    ...
    // List<?> getIllegalLevelNamesResult = (List<?>)
    // getIllegalLevelNames.invoke(checker);
    // assertTrue(
    // "Correct illegal level names.",
    // getIllegalLevelNamesResult.containsAll(Arrays.asList(new String[] {
    // "void",
    // "1*", "h()" }))
    ...
    // List<?> getInvalidIdFunctionAnnotationResult = (List<?>)
    // getInvalidIdFunctionAnnotation
    // .invoke(checker);
    ...
    // List<?> getUnavailableIdFunctionsResult = (List<?>)
    // getUnavailableIdFunctions
    // .invoke(checker);
    // assertTrue(
    ...
    // Method getUnavailableIdFunctionAnnotation =
    // SecurityLevelImplChecker.class
    // .getDeclaredMethod("getUnavailableIdFunctionAnnotation");
    // getUnavailableIdFunctionAnnotation.setAccessible(true);
    // List<?> getUnavailableIdFunctionAnnotationResult = (List<?>)
    // getUnavailableIdFunctionAnnotation
    // .invoke(checker);
    // assertTrue(
    ...
    // JUnitSootSecurityLevelImplementation3 impl = new
    // JUnitSootSecurityLevelImplementation3();
    // SecurityLevelImplChecker checker = null;
    // try {
    // checker = getChecker(impl, false);
    // } catch (Exception e) {
    ...
    // List<?> getIllegalLevelNamesResult = (List<?>)
    // getIllegalLevelNames.invoke(checker);
    // assertTrue("No illegal level names.",
    // getIllegalLevelNamesResult.isEmpty());
    // Method getInvalidIdFunctions = SecurityLevelImplChecker.class
    // .getDeclaredMethod("getInvalidIdFunctions");
    // getInvalidIdFunctions.setAccessible(true);
    // List<?> getInvalidIdFunctionsResult = (List<?>) getInvalidIdFunctions
    // .invoke(checker);
    // assertTrue("No invalid id functions.",
    // getInvalidIdFunctionsResult.isEmpty());
    // Method getInvalidIdFunctionAnnotation = SecurityLevelImplChecker.class
    // .getDeclaredMethod("getInvalidIdFunctionAnnotation");
    // getInvalidIdFunctionAnnotation.setAccessible(true);
    // List<?> getInvalidIdFunctionAnnotationResult = (List<?>)
    ...
    // public final void testInvalidSootSecurityImplementation3() throws
    // SecurityException {
    // JUnitSootSecurityLevelImplementation2 impl = new
    // JUnitSootSecurityLevelImplementation2();
    ...
    // JUnitSootSecurityLevelImplementation4 impl = new
    // JUnitSootSecurityLevelImplementation4();
    // SecurityLevelImplChecker checker = null;
    // try {
    // checker = getChecker(impl, false);
    // } catch (Exception e) {
    ...
    // JUnitSootSecurityLevelImplementation1 impl = new
    // JUnitSootSecurityLevelImplementation1();
    // SecurityLevelImplChecker checker = null;
    // try {
