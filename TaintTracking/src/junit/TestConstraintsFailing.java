...
public class TestConstraintsFailing {
    ...
    private static final TestFile INVALID01 = new TestFile(TEST_PACKAGE,
                                                           "Invalid01");
    private static final TestFile INVALID02 = new TestFile(TEST_PACKAGE,
                                                           "Invalid02");
    private static final TestFile INVALID03 = new TestFile(TEST_PACKAGE,
                                                           "Invalid03");
    private static final TestFile INVALID04 = new TestFile(TEST_PACKAGE,
                                                           "Invalid04");
    private static final TestFile INVALID05 = new TestFile(TEST_PACKAGE,
                                                           "Invalid05");
    private static final TestFile INVALID06 = new TestFile(TEST_PACKAGE,
                                                           "Invalid06");
    private static final TestFile INVALID07 = new TestFile(TEST_PACKAGE,
                                                           "Invalid07");
    private static final TestFile INVALID08 = new TestFile(TEST_PACKAGE,
                                                           "Invalid08");
    private static final TestFile INVALID09 = new TestFile(TEST_PACKAGE,
                                                           "Invalid09");
    private static final TestFile INVALID10 = new TestFile(TEST_PACKAGE,
                                                           "Invalid10");
    private static final TestFile INVALID11 = new TestFile(TEST_PACKAGE,
                                                           "Invalid11");
    private static final TestFile INVALID12 = new TestFile(TEST_PACKAGE,
                                                           "Invalid12");
    private static final TestFile INVALID13 = new TestFile(TEST_PACKAGE,
                                                           "Invalid13");
    private static final TestFile INVALID14 = new TestFile(TEST_PACKAGE,
                                                           "Invalid14");
    private static final TestFile INVALID15 = new TestFile(TEST_PACKAGE,
                                                           "Invalid15");
    private static final TestFile INVALID16 = new TestFile(TEST_PACKAGE,
                                                           "Invalid16");
    private static final TestFile INVALID17 = new TestFile(TEST_PACKAGE,
                                                           "Invalid17");
    private static final TestFile INVALID18 = new TestFile(TEST_PACKAGE,
                                                           "Invalid18");
    private static final TestFile INVALID19 = new TestFile(TEST_PACKAGE,
                                                           "Invalid19");
    private static final TestFile INVALID20 = new TestFile(TEST_PACKAGE,
                                                           "Invalid20");
    private static final TestFile INVALID21 = new TestFile(TEST_PACKAGE,
                                                           "Invalid21");
    private static final TestFile INVALID22 = new TestFile(TEST_PACKAGE,
                                                           "Invalid22");
    private static final TestFile INVALID23 = new TestFile(TEST_PACKAGE,
                                                           "Invalid23");
    private static final TestFile INVALID24 = new TestFile(TEST_PACKAGE,
                                                           "Invalid24");
    private static final TestFile INVALID25 = new TestFile(TEST_PACKAGE,
                                                           "Invalid25");
    private static final TestFile INVALID26 = new TestFile(TEST_PACKAGE,
                                                           "Invalid26");
    private static final TestFile INVALID27 = new TestFile(TEST_PACKAGE,
                                                           "Invalid27");
    private static final TestFile INVALID28 = new TestFile(TEST_PACKAGE,
                                                           "Invalid28");
    private static final TestFile INVALID29 = new TestFile(TEST_PACKAGE,
                                                           "Invalid29");
    private static final TestFile INVALID30 = new TestFile(TEST_PACKAGE,
                                                           "Invalid30");
    private static final TestFile INVALID31 = new TestFile(TEST_PACKAGE,
                                                           "Invalid31");
    private static final TestFile INVALID32 = new TestFile(TEST_PACKAGE,
                                                           "Invalid32");
    private static final TestFile INVALID33 = new TestFile(TEST_PACKAGE,
                                                           "Invalid33");
    private static final TestFile INVALID34 = new TestFile(TEST_PACKAGE,
                                                           "Invalid34");
    private static final TestFile INVALID35 = new TestFile(TEST_PACKAGE,
                                                           "Invalid35");
    private static final TestFile INVALID36 = new TestFile(TEST_PACKAGE,
                                                           "Invalid36");
    private static final TestFile INVALID37 = new TestFile(TEST_PACKAGE,
                                                           "Invalid37");
    private static final TestFile INVALID38 = new TestFile(TEST_PACKAGE,
                                                           "Invalid38");
    private static final TestFile LEVEL_FUNCTION =
        new TestFile(TEST_PACKAGE, "FailLevelFunction");
    private static final TestFile METHOD_INSTANCE =
        new TestFile(TEST_PACKAGE, "FailMethodInstance");
    private static final TestFile METHOD_STATIC =
        new TestFile(TEST_PACKAGE, "FailMethodStatic");
    private static final TestFile FIELD_INSTANCE =
        new TestFile(TEST_PACKAGE, "FailFieldInstance");
    private static final TestFile FIELD_STATIC =
        new TestFile(TEST_PACKAGE, "FailFieldStatic");
    ...
    private static final TestFile ARRAY = new TestFile(TEST_PACKAGE,
                                                       "FailArray");
    private static final TestFile INHERITANCE = new TestFile(TEST_PACKAGE,
                                                             "FailInheritance");
    private static final TestFile EFFECT = new TestFile(TEST_PACKAGE,
                                                        "FailWriteEffect");
    private static final TestFile ARRAY_SIGNATURE =
        new TestFile(TEST_PACKAGE, "FailArraySignature");
    private static final TestFile ARRAY_ASSIGN =
        new TestFile(TEST_PACKAGE, "FailArrayAssign");
    private static final TestFile ASSIGN_SAME = new TestFile(TEST_PACKAGE,
                                                             "FailAssignSame");
    private static final TestFile PUTFIELD_IMPLICIT_LEAK =
        new TestFile(TEST_PACKAGE, "FailPutfieldImplicitLeak");
    private static final TestFile EXAMPLE01 = new TestFile(TEST_PACKAGE,
                                                           "FailExample01");
    ...
    public final void test81FailPutfieldImplicitLeak() {
        checkMethodStoreEquality(PUTFIELD_IMPLICIT_LEAK,
                                 CHECK_LEVELS,
                                 CONSTRAINTS);
    }
