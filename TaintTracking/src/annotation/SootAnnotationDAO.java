...
public class SootAnnotationDAO extends AAnnotationDAO {
	...
	private SootAnnotationDAO convertAnnotation(AnnotationElem ae, Class<? extends Annotation> annotationClass) {
		...
		throw new AnnotationElementNotFoundException(getMsg("exception.annotation.invalid_annotation_type", annotationClass.getName()));
	}
	...
	private <V extends Enum<V>> V convertEnum(AnnotationElem ae, Class<V> enumClass) throws ClassCastException {
		...
		throw new AnnotationElementNotFoundException(getMsg("exception.annotation.invalid_enum_type", enumClass.getName()));
	}
	...
	private Class<?> getUsedClass(String jni) {
		if (PRIM_CLASSES.containsKey(jni)) {
			...
			try {
				...
				throw new AnnotationElementNotFoundException(getMsg("exception.annotation.not_found_class", javaPath));
			}
		}
	}
