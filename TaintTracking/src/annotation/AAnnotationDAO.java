...
public abstract class AAnnotationDAO implements IAnnotationDAO {
    ...
    protected static final Map<String, Class<?>> PRIM_CLASSES =
    ...
    public abstract List<IAnnotationDAO> getAnnotationArrayFor(String name,
                                                               Class<? extends Annotation> annotationClass);

    public abstract IAnnotationDAO getAnnotationFor(String name,
                                                    Class<? extends Annotation> annotationClass);
    ...
    public abstract <V extends Enum<V>> V getEnumFor(String name,
                                                     Class<V> enumClass);
