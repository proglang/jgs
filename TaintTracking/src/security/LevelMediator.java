...
/**
 * <h1>Security Level Mediator</h1>
 * 
 * The {@link LevelMediator} class wraps the ordered
 ...
 * ordered list of <em>security levels</em>. The {@link LevelMediator}
...
public class LevelMediator {
	 ...
	 * e.g. {@link LevelMediator#VOID_LEVEL}.
	 * 
	 ...
	 * {@link LevelMediator#SecurityAnnotation(List)}.
	 */
	 ...
	 * constructor {@link LevelMediator#SecurityAnnotation(List)}.
	 */
	private final List<String> idFunctionNames = new ArrayList<String>();

	/**
	 * Constructor for the {@link LevelMediator} class. The constructor
	 ...
	 */
	public LevelMediator(List<String> levels) {
		super();
	 ...
	 * {@link LevelMediator#availableLevels} contains the given level, this
	 * level is valid.
	 * 
	 * @param level
	 ...
	 * {@link LevelMediator#availableLevels} contains all the given levels,
	 ...
	 * {@link LevelMediator#availableLevels} or it is an valid variable
	 ...
	 * {@link LevelMediator#LEVEL_PATTERN_SIGN} followed by a number in the
	 ...
	 * {@link LevelMediator#availableLevels}. The content of this list
	 ...
	 * {@link LevelMediator#availableLevels}.
	 * 
	 * @param levels
	 ...
	 * @see LevelMediator#checkValidityOfLevel(String)
	 */
	 ...
	 * {@link LevelMediator#availableLevels} and each parameter level which
	 ...
	 * @see LevelMediator#getInvalidLevels(List)
	 */
	 ...
	 * {@link LevelMediator#VOID_LEVEL}), the method will throw an
	 * exception. Otherwise the strongest level, i.e. the level with smallest
	 * index in the list of available levels
	 * {@link LevelMediator#availableLevels} which is also in the given
	 ...
	 * @see LevelMediator#checkValidityOfLevels(List)
	 */
	 ...
	 * index in the list of available levels
	 * {@link LevelMediator#availableLevels} will be returned. The method
	 * will throw an exception if one of the given levels is not valid and also
	 * not 'void' ( {@link LevelMediator#VOID_LEVEL}).
	 * 
	 * @param level1
	 ...
	 *         {@link LevelMediator#availableLevels}.
	 * @see LevelMediator#isIdFunction(SootMethod)
	 */
	 ...
	 * {@link LevelMediator#availableLevels}, i.e. the level with the index
	 ...
	 * list of available levels {@link LevelMediator#availableLevels} is
	 ...
	 *             <em>security level</em>.
	 * @see LevelMediator#availableLevels
	 */
	...
	public boolean hasReturnSecurityAnnotation(SootMethod sootMethod) {
		return hasAnnotationWithType(sootMethod,
				getJNISignature(Annotations.ReturnSecurity.class));
	}
	...
	public boolean hasParameterSecurityAnnotation(SootMethod sootMethod) {
		return hasAnnotationWithType(sootMethod,
				getJNISignature(Annotations.ParameterSecurity.class));
	}
	...
	private boolean hasWriteEffectAnnotation(Host host) {
		return hasAnnotationWithType(host,
				getJNISignature(Annotations.WriteEffect.class));
	}
	...
	public boolean hasFieldSecurityAnnotation(SootField sootField) {
		return hasAnnotationWithType(sootField,
				getJNISignature(Annotations.FieldSecurity.class));
	}
	...
	public List<String> extractClassEffects(SootClass sootClass)
			throws ExtractionException {
		AnnotationElem annotationElem = extractAnnotationElementFromHost(
				sootClass, getJNISignature(Annotations.WriteEffect.class),
				ANNOTATION_ELEMENT_NAME, SootUtils.ELEMENT_KIND_ARRAY);
		return SootUtils.convertAnnotationElementIntoStringList(annotationElem);
	}
	...
	private AnnotationElem extractAnnotationElementFromHost(Host host,
		...
		try {
			java.lang.annotation.Annotation test = (java.lang.annotation.Annotation) annotation;
