...
public class ExtendedSecurityLevelImplChecker extends SecurityLevelImplChecker {
		...
		if (compileSootSecurityLevelFile() == 0) {
			...
			try {
				...
				Class<?> sootSecurityLevelClass = classLoader
						.loadClass("security.SootSecurityLevel");
				...
				log.securitychecker(SecurityMessages
						.impossibleToLoadSecurityLevelClass("security.SootSecurityLevel"), e);
	 ...
	 * {@link Configuration} (see {@link Configuration#DEF_PATH_JAVA}).
	 * 
	 ...
	 * implemented. This implementation is located as defined in the class {@link Configuration} (see
	 * {@link Configuration#DEF_PATH_FILE}).
	 * 
	 * @throws IOException
