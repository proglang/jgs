 ...
 * {@link Configuration#DEF_PATH_JAVA}) <b>[the {@link SecurityLevelImplChecker} doesn't consider
...
public class SecurityLevelImplChecker {
	 ...
	 * 'SootSecurityLevel'.
	 * 
	 * @see Configuration#DEF_PATH_FILE
	 */
	...
	private boolean checkValidityOfLevel(Class<?> sootSecurityLevelClass, List<String> methodNames,
			String level) {
		boolean valid = true;
		if (LevelMediator.ADDITIONAL_LEVELS.contains(level)) {
