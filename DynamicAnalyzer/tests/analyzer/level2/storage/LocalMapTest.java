...
public class LocalMapTest {
	...
	public void testInsertElementStringLevel() {
		...
		lm.insertInitializedLocal("a1", SecurityLevel.bottom());
		lm.insertInitializedLocal("a2");
		lm.insertInitializedLocal("a3", SecurityLevel.top());
